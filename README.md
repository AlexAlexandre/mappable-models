...
{
    "dependencies": {
        "alexalexandre/mappable-models": "dev-master"
    }
}
```
...
`composer require alexalexandre/mappable-models`
...
`AlexAlexandre\MappableModels\MappableModel` 

Também, caso necessário (quando for preciso salvar nested models), usem a seguinte trait:

`AlexAlexandre\MappableModels\Traits\HasNestedAttributes`
