...
namespace AlexAlexandre\MappableModels;

use AlexAlexandre\MappableModels\Mapping\ModelMapping;
use AlexAlexandre\MappableModels\Traits\HasArrayMappableFormat;
use AlexAlexandre\MappableModels\Traits\HasAutomaticMapping;
